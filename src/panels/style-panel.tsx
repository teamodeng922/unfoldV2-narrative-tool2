...
function Section({
  ...
  return (
    <section className="mb-6">
      <h3 className="mb-2.5 text-[14px] font-semibold tracking-[0.04em] text-white/60">
        {title}
      </h3>
      {children}
    </section>
          ...
          {ART_STYLES.map((style) => {
            ...
            return (
              ...
              >
                ...
                />
                {!fit ? (
                  <span className="absolute right-2 top-2 rounded bg-black/45 px-2 py-1 text-[10px] text-white/65">
                    不适配
                  </span>
                ) : null}
                {active && fit ? (
                ...
                <div className="p-3">
                  ...
                  <p className="text-[13px] leading-5 text-white/35">{style.ref}</p>
                </div>
              </button>
            );
          })}
          ...
          {PROPORTIONS.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className="mt-1 block text-[13px] text-white/35">{item.desc}</span>
              </button>
            );
          })}
        </div>
